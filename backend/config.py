...
BASE_DATA_DIR = "/tmp" if IS_PRODUCTION else "./data"
...
class Settings(BaseSettings):
    ...
    upload_dir: str = f"{BASE_DATA_DIR}/uploads"
    max_file_size_mb: int = 20

    api_host: str = "0.0.0.0"
    api_port: int = 8000
    api_reload: bool = not IS_PRODUCTION  # False in production

    api_base_url: str = "http://localhost:8000"

    log_level: str = "INFO"
    log_file: str = "/tmp/app.log" if IS_PRODUCTION else "./logs/app.log"
